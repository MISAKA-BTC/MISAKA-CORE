...
impl SigningCoordinatorState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, SigningCoordinatorError> {
        ...
        let entry = SigningCoordinatorEntry {
            ...
            created_at: now,
            updated_at: now,
            state: SigningCoordinatorEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(SigningCoordinatorTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), SigningCoordinatorError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(SigningCoordinatorError::NotFound(id))?;
        ...
        self.emit(SigningCoordinatorEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, SigningCoordinatorError> {
        ...
        self.emit(SigningCoordinatorEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<SigningCoordinatorEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    SigningCoordinatorEntryState::Completed
                        | SigningCoordinatorEntryState::Failed
                        | SigningCoordinatorEntryState::Cancelled
                        | SigningCoordinatorEntryState::Expired
        ...
        if removed > 0 {
            self.emit(SigningCoordinatorEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> SigningCoordinatorStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<SigningCoordinatorEvent> {
