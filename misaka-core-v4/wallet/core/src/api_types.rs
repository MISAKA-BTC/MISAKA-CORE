...
pub enum SendMode {
    /// Public transfer — sender visible, anonymity_set_size=1. TxType=6, scheme=0x20.
    Transparent,
    /// Lattice ZKP proof — sender hidden among decoys. TxType=0, scheme=0x01/0x03.
    Private,
