...
impl MigrationState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, MigrationError> {
        ...
        let entry = MigrationEntry {
            ...
            created_at: now,
            updated_at: now,
            state: MigrationEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(MigrationTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn get(&self, id: u64) -> Option<MigrationEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    MigrationEntryState::Completed
                        | MigrationEntryState::Failed
                        | MigrationEntryState::Cancelled
                        | MigrationEntryState::Expired
        ...
        if removed > 0 {
            self.emit(MigrationEvent::Cleanup {
                removed,
    ...
    pub fn drain_events(&self) -> Vec<MigrationEvent> {
