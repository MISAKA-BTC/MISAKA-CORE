...
impl QrEncodingState {
    ...
    pub fn create(
        ...
        let entry = QrEncodingEntry {
            ...
            created_at: now,
            updated_at: now,
            state: QrEncodingEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(QrEncodingTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), QrEncodingError> {
        ...
        self.emit(QrEncodingEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, QrEncodingError> {
        ...
        self.emit(QrEncodingEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<QrEncodingEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    QrEncodingEntryState::Completed
                        | QrEncodingEntryState::Failed
                        | QrEncodingEntryState::Cancelled
                        | QrEncodingEntryState::Expired
        ...
        if removed > 0 {
            self.emit(QrEncodingEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> QrEncodingStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<QrEncodingEvent> {
