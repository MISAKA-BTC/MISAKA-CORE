...
impl TxProofParams {
    ...
    pub fn compute_weight(&self) -> u64 {
        let membership_per_input = COST_UNIFIED_MEMBERSHIP_BASE
            + (self.max_merkle_depth as u64) * COST_PER_MERKLE_LEVEL;
...
mod tests {
    ...
    fn test_tx_count_exceeded() {
        ...
        let params = TxProofParams {
            ...
            max_merkle_depth: 1, range_bits: 64,
        };
    ...
    fn test_can_afford_check() {
        ...
        let big = TxProofParams {
            ...
            max_merkle_depth: 20, range_bits: 64,
        };
    ...
    fn test_depth_affects_weight() {
        let shallow = TxProofParams {
            num_inputs: 1, num_outputs: 1,
            max_merkle_depth: 2, range_bits: 64,
        };
        let deep = TxProofParams {
            num_inputs: 1, num_outputs: 1,
            max_merkle_depth: 20, range_bits: 64,
        };
        assert!(deep.compute_weight() > shallow.compute_weight(),
