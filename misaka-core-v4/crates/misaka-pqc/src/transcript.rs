...
impl TranscriptBuilder {
    ...
    pub fn append(&mut self, label: &[u8], data: &[u8]) {
        assert!(!self.squeezed, "transcript already squeezed — cannot append");
    ...
    pub fn challenge(mut self, challenge_label: &[u8]) -> [u8; 32] {
        ...
        self.hasher.update(&(challenge_label.len() as u16).to_le_bytes());
    ...
    pub fn fork(&self) -> Self {
        ...
        Self { hasher: self.hasher.clone(), squeezed: false }
    }
}
...
impl TranscriptSchema {
    ...
    pub fn build_canonical(
        &self,
        fields: &[(&[u8], &[u8])],
    ) -> Result<TranscriptBuilder, String> {
...
mod schema_tests {
    ...
    fn test_membership_sigma_schema_field_count() {
        ...
        assert_eq!(canonical_schemas::MEMBERSHIP_SIGMA.fields.len(), 8,
    ...
    fn test_transcript_avalanche_property() {
        ...
        for pos in [0, 1, 100, 255, 511] {
            ...
            assert_ne!(c_base, c_mod,
                "flipping bit at position {} must change challenge", pos);
        }
    }
    ...
    fn test_transcript_domain_separation_property() {
        ...
        assert_ne!(c1, c2, "different domain tags must produce different challenges");
    }
    ...
    fn test_transcript_label_binding_property() {
        ...
        assert_ne!(c1, c2, "different labels with same data must produce different challenges");
    }
    ...
    fn test_transcript_challenge_label_binding_property() {
        ...
        assert_ne!(c1, c2, "different challenge labels must produce different challenges");
    }
}
