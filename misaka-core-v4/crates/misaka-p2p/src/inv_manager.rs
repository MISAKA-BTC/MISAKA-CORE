...
impl InvManagerState {
    ...
    pub fn create(
        ...
        let entry = InvManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: InvManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(InvManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), InvManagerError> {
        ...
        self.emit(InvManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, InvManagerError> {
        ...
        self.emit(InvManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<InvManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    InvManagerEntryState::Completed
                        | InvManagerEntryState::Failed
                        | InvManagerEntryState::Cancelled
                        | InvManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(InvManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> InvManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<InvManagerEvent> {
