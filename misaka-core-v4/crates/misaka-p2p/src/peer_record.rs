...
bitflags::bitflags! {
    ...
    pub struct CapabilityFlags: u32 {
        ...
        /// Reserved (formerly CT — confidential transactions, removed in v1.0).
        /// Do not reuse this bit position; existing peers may still advertise it.
        const _RESERVED_CT = 0b0001_0000;
