...
//!     spent_root: <Merkle root of spent set>,
...
impl CheckpointManager {
    ...
    pub fn create_checkpoint(
        ...
        info!(
            "Checkpoint created: score={} tip={} state_root={} content_hash={} ({} spent_tags, {} utxos)",
