...
// The trait and store impl are the only remaining items from legacy_ghostdag.
...
pub use crate::ghostdag_v2::{
    validate_header_topology, EpochAwareStakeProvider, GhostDagError, GhostDagV2 as GhostDagEngine,
    HeaderTopologyError, StakeWeightProvider, UniformStakeProvider, DEFAULT_K, MAX_MERGESET_SIZE,
    MAX_PARENTS, PRUNING_WINDOW,
};

// ── Canonical parent selection ──
pub use crate::parent_selection::{
    canonical_compare, select_canonical_parents, select_parent as canonical_select_parent,
    ParentSortKey,
};
