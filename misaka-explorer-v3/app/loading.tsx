  ...
  return (
    <div className="page-enter space-y-10">
      ...
      <section className="text-center pt-6 pb-4">
        ...
        <div className="skeleton h-12 w-full max-w-2xl rounded-none mx-auto" />
      </section>

      {/* Stats grid */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="rounded-none border border-surface-300/50 bg-hover100 p-5">
      ...
      {/* Chart skeleton */}
      <div className="rounded-none border border-surface-300/50 bg-hover100 p-5">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {[0, 1].map((i) => (
          <div key={i} className="rounded-none border border-surface-300/50 bg-hover100 p-5 space-y-3">
