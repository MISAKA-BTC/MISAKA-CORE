...
#[cfg(test)]
mod tests {
    use super::{linear_consumer_surfaces_json, linear_privacy_path_surface_json, stored_tx_to_info};
    ...
    fn test_stored_tx_to_info_exposes_privacy_metadata() {
        ...
        assert_eq!(json["privacy"]["spendIdentifierModel"], "canonicalNullifier");
    ...
    fn test_linear_privacy_path_surface_json_splits_runtime_and_target() {
        ...
        assert_eq!(json["runtimePath"], serde_json::Value::String("ringSignature".into()));
