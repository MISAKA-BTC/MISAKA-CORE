...
impl KdfState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, KdfError> {
        ...
        self.queue.lock().push_back(KdfTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn get(&self, id: u64) -> Option<KdfEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    KdfEntryState::Completed
                        | KdfEntryState::Failed
                        | KdfEntryState::Cancelled
                        | KdfEntryState::Expired
    ...
    pub fn stats(&self) -> KdfStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<KdfEvent> {
