...
impl CommitmentState {
    ...
    pub fn create(
        ...
        let entry = CommitmentEntry {
            ...
            created_at: now,
            updated_at: now,
            state: CommitmentEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(CommitmentTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), CommitmentError> {
        ...
        self.emit(CommitmentEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, CommitmentError> {
        ...
        self.emit(CommitmentEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<CommitmentEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    CommitmentEntryState::Completed
                        | CommitmentEntryState::Failed
                        | CommitmentEntryState::Cancelled
                        | CommitmentEntryState::Expired
        ...
        if removed > 0 {
            self.emit(CommitmentEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> CommitmentStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<CommitmentEvent> {
