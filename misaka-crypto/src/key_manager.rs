...
impl KeyManagerState {
    ...
    pub fn create(
        ...
        let entry = KeyManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: KeyManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(KeyManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), KeyManagerError> {
        ...
        self.emit(KeyManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, KeyManagerError> {
        ...
        self.emit(KeyManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<KeyManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    KeyManagerEntryState::Completed
                        | KeyManagerEntryState::Failed
                        | KeyManagerEntryState::Cancelled
                        | KeyManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(KeyManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> KeyManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<KeyManagerEvent> {
