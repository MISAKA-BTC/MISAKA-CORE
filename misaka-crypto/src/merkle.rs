...
impl MerkleState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, MerkleError> {
        ...
        self.queue.lock().push_back(MerkleTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), MerkleError> {
        ...
        self.emit(MerkleEvent::Completed {
            id,
    ...
    pub fn get(&self, id: u64) -> Option<MerkleEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    MerkleEntryState::Completed
                        | MerkleEntryState::Failed
                        | MerkleEntryState::Cancelled
                        | MerkleEntryState::Expired
    ...
    pub fn stats(&self) -> MerkleStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<MerkleEvent> {
