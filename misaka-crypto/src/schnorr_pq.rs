...
impl SchnorrPqState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, SchnorrPqError> {
        ...
        let entry = SchnorrPqEntry {
            ...
            created_at: now,
            updated_at: now,
            state: SchnorrPqEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(SchnorrPqTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), SchnorrPqError> {
        ...
        self.emit(SchnorrPqEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, SchnorrPqError> {
        ...
        self.emit(SchnorrPqEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<SchnorrPqEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    SchnorrPqEntryState::Completed
                        | SchnorrPqEntryState::Failed
                        | SchnorrPqEntryState::Cancelled
                        | SchnorrPqEntryState::Expired
        ...
        if removed > 0 {
            self.emit(SchnorrPqEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> SchnorrPqStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<SchnorrPqEvent> {
