...
fn default_ring_scheme() -> u8 { 0x01 }
...
impl UtxoTransaction {
    ...
    pub fn max_ring_size(&self) -> usize {
        if self.is_v2() { MAX_RING_SIZE_V2 } else { MAX_RING_SIZE_V1 }
    }
...
mod tests {
    ...
    fn make_utxo_tx_v1() -> UtxoTransaction {
        UtxoTransaction {
            ...
            outputs: vec![TxOutput { amount: 9900, one_time_address: [0xCC; 20], pq_stealth: None }],
            fee: 100,
            extra: vec![],
        }
    }
