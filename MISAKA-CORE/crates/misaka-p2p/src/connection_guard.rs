...
fn default_max_handshake_attempts() -> u32 { MAX_HANDSHAKE_ATTEMPTS_PER_IP }
fn default_throttle_window() -> u64 { THROTTLE_WINDOW_SECS }
fn default_max_half_open() -> usize { MAX_HALF_OPEN }
fn default_half_open_timeout() -> u64 { HALF_OPEN_TIMEOUT_SECS }
fn default_max_inbound_per_subnet() -> usize { MAX_INBOUND_PER_SUBNET }
fn default_max_inbound_per_ip() -> usize { MAX_INBOUND_PER_IP }
fn default_cleanup_interval() -> u64 { CLEANUP_INTERVAL_SECS }
...
mod tests {
    ...
    fn test_half_open_limit() {
        ...
        for i in 0..MAX_HALF_OPEN {
            let ip = ipv4(10 + (i / 256 / 256) as u8, (i / 256 % 256) as u8, (i % 256) as u8, 1);
    ...
    fn test_default_config_matches_constants() {
        ...
        assert_eq!(config.max_handshake_attempts_per_ip, MAX_HANDSHAKE_ATTEMPTS_PER_IP);
