...
pub use packing::{
    pack_ring_sig, pack_ring_sig_v2, unpack_legacy_proof, unpack_legacy_proof_v2, PACKED_RESPONSE_SIZE,
};
pub use pq_kem::{
    MlKemCiphertext, MlKemKeypair, MlKemPublicKey, MlKemSecretKey, MlKemSharedSecret,
};
pub use pq_ring::{
    compute_key_image, derive_public_param, pq_sign, ring_verify, Poly, LegacyProofData, SpendingKeypair,
    DEFAULT_A_SEED,
};
...
pub use privacy_dispatch::{
    ...
    LegacyVerifyError, LegacyVerifyInput, PrivacyBackendPreference, SelectedPrivacyBackend, UnifiedZkpVerifyInput,
};
#[cfg(feature = "stark-stub")] // DEV-ONLY: Stub ZK verifier — blocked in release builds
pub use privacy_dispatch::{
