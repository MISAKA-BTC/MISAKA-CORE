...
pub const FEATURE_ACTIVATIONS: &[FeatureActivation] = &[
    FeatureActivation {
        ...
        introduced_in: 1,
        description: "Post-quantum lattice ZKP proofs (LRS/LogRing) for transaction privacy",
    },
    FeatureActivation {
        name: "ki-proof-required",
        activation_height: 0,
        introduced_in: 1,
        description: "Key image proofs mandatory for all lattice ZKP proof inputs",
    },
    FeatureActivation {
        name: "dag-consensus",
