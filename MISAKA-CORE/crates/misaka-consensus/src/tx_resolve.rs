...
use misaka_pqc::pq_ring::{derive_public_param, Poly, LegacyProofData, DEFAULT_A_SEED};
...
use misaka_types::utxo::{UtxoTransaction, PROOF_SCHEME_DEPRECATED_LOGRING, PROOF_SCHEME_DEPRECATED_LRS, PROOF_SCHEME_TRANSPARENT};
...
#[allow(dead_code)]
fn parse_legacy_proof(raw: &[u8], anonymity_set_size: usize, input_idx: usize) -> Result<LegacyProofData, ResolveError> {
