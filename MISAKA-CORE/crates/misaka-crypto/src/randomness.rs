...
impl RandomnessState {
    ...
    pub fn create(
        ...
        let entry = RandomnessEntry {
            ...
            created_at: now,
            updated_at: now,
            state: RandomnessEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(RandomnessTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), RandomnessError> {
        ...
        self.emit(RandomnessEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, RandomnessError> {
        ...
        self.emit(RandomnessEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<RandomnessEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    RandomnessEntryState::Completed
                        | RandomnessEntryState::Failed
                        | RandomnessEntryState::Cancelled
                        | RandomnessEntryState::Expired
        ...
        if removed > 0 {
            self.emit(RandomnessEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> RandomnessStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<RandomnessEvent> {
