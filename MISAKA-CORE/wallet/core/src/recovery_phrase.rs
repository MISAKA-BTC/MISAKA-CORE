...
impl RecoveryPhraseState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, RecoveryPhraseError> {
        ...
        let entry = RecoveryPhraseEntry {
            ...
            created_at: now,
            updated_at: now,
            state: RecoveryPhraseEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(RecoveryPhraseTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), RecoveryPhraseError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(RecoveryPhraseError::NotFound(id))?;
        ...
        self.emit(RecoveryPhraseEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, RecoveryPhraseError> {
        ...
        self.emit(RecoveryPhraseEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<RecoveryPhraseEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    RecoveryPhraseEntryState::Completed
                        | RecoveryPhraseEntryState::Failed
                        | RecoveryPhraseEntryState::Cancelled
                        | RecoveryPhraseEntryState::Expired
        ...
        if removed > 0 {
            self.emit(RecoveryPhraseEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> RecoveryPhraseStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<RecoveryPhraseEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = RecoveryPhraseConfig {
            retry_count: 2,
            ..Default::default()
        };
