...
impl UtxoScannerState {
    ...
    pub fn create(
        ...
        let entry = UtxoScannerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: UtxoScannerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(UtxoScannerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), UtxoScannerError> {
        ...
        self.emit(UtxoScannerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, UtxoScannerError> {
        ...
        self.emit(UtxoScannerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<UtxoScannerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    UtxoScannerEntryState::Completed
                        | UtxoScannerEntryState::Failed
                        | UtxoScannerEntryState::Cancelled
                        | UtxoScannerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(UtxoScannerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> UtxoScannerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<UtxoScannerEvent> {
