...
impl WasmBindingsState {
    ...
    pub fn create(
        ...
        let entry = WasmBindingsEntry {
            ...
            created_at: now,
            updated_at: now,
            state: WasmBindingsEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(WasmBindingsTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), WasmBindingsError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(WasmBindingsError::NotFound(id))?;
        ...
        self.emit(WasmBindingsEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, WasmBindingsError> {
        ...
        self.emit(WasmBindingsEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<WasmBindingsEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    WasmBindingsEntryState::Completed
                        | WasmBindingsEntryState::Failed
                        | WasmBindingsEntryState::Cancelled
                        | WasmBindingsEntryState::Expired
        ...
        if removed > 0 {
            self.emit(WasmBindingsEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> WasmBindingsStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<WasmBindingsEvent> {
