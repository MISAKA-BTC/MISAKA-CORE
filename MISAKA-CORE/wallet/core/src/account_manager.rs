...
impl AccountManagerState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, AccountManagerError> {
        ...
        let entry = AccountManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: AccountManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(AccountManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), AccountManagerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(AccountManagerError::NotFound(id))?;
        ...
        self.emit(AccountManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, AccountManagerError> {
        ...
        self.emit(AccountManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<AccountManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    AccountManagerEntryState::Completed
                        | AccountManagerEntryState::Failed
                        | AccountManagerEntryState::Cancelled
                        | AccountManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(AccountManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> AccountManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<AccountManagerEvent> {
