...
impl FeeCalculatorState {
    ...
    pub fn create(
        ...
        let entry = FeeCalculatorEntry {
            ...
            created_at: now,
            updated_at: now,
            state: FeeCalculatorEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(FeeCalculatorTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), FeeCalculatorError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(FeeCalculatorError::NotFound(id))?;
        ...
        self.emit(FeeCalculatorEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, FeeCalculatorError> {
        ...
        self.emit(FeeCalculatorEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<FeeCalculatorEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    FeeCalculatorEntryState::Completed
                        | FeeCalculatorEntryState::Failed
                        | FeeCalculatorEntryState::Cancelled
                        | FeeCalculatorEntryState::Expired
        ...
        if removed > 0 {
            self.emit(FeeCalculatorEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> FeeCalculatorStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<FeeCalculatorEvent> {
