...
impl DerivationCacheState {
    ...
    pub fn create(
        ...
        let entry = DerivationCacheEntry {
            ...
            created_at: now,
            updated_at: now,
            state: DerivationCacheEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(DerivationCacheTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), DerivationCacheError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(DerivationCacheError::NotFound(id))?;
        ...
        self.emit(DerivationCacheEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, DerivationCacheError> {
        ...
        self.emit(DerivationCacheEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<DerivationCacheEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    DerivationCacheEntryState::Completed
                        | DerivationCacheEntryState::Failed
                        | DerivationCacheEntryState::Cancelled
                        | DerivationCacheEntryState::Expired
        ...
        if removed > 0 {
            self.emit(DerivationCacheEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> DerivationCacheStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<DerivationCacheEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = DerivationCacheConfig {
            retry_count: 2,
            ..Default::default()
        };
