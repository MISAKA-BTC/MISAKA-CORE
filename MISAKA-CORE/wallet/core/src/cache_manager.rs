...
impl CacheManagerState {
    ...
    pub fn create(
        ...
        let entry = CacheManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: CacheManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(CacheManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), CacheManagerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(CacheManagerError::NotFound(id))?;
        ...
        self.emit(CacheManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, CacheManagerError> {
        ...
        self.emit(CacheManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<CacheManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    CacheManagerEntryState::Completed
                        | CacheManagerEntryState::Failed
                        | CacheManagerEntryState::Cancelled
                        | CacheManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(CacheManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> CacheManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<CacheManagerEvent> {
