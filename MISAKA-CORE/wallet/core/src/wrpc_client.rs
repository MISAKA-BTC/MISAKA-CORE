...
impl AtomicU8Wrapper {
    fn new(val: u8) -> Self {
        Self(std::sync::atomic::AtomicU8::new(val))
    }
...
impl WalletRpcClient {
    ...
    pub fn handle_notification(&self, method: &str, _params: &serde_json::Value) {
...
impl WalletRpcClient {
    ...
    pub fn subscribe_utxos_changed(&self, _addresses: &[String]) -> u64 {
