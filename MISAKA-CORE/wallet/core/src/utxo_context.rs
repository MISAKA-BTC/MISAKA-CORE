...
impl UtxoContextState {
    ...
    pub fn create(
        ...
        let entry = UtxoContextEntry {
            ...
            created_at: now,
            updated_at: now,
            state: UtxoContextEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(UtxoContextTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), UtxoContextError> {
        ...
        self.emit(UtxoContextEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, UtxoContextError> {
        ...
        self.emit(UtxoContextEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<UtxoContextEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    UtxoContextEntryState::Completed
                        | UtxoContextEntryState::Failed
                        | UtxoContextEntryState::Cancelled
                        | UtxoContextEntryState::Expired
        ...
        if removed > 0 {
            self.emit(UtxoContextEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> UtxoContextStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<UtxoContextEvent> {
