...
impl NotificationHandlerState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, NotificationHandlerError> {
        ...
        let entry = NotificationHandlerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: NotificationHandlerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(NotificationHandlerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), NotificationHandlerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(NotificationHandlerError::NotFound(id))?;
        ...
        self.emit(NotificationHandlerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, NotificationHandlerError> {
        ...
        self.emit(NotificationHandlerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<NotificationHandlerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    NotificationHandlerEntryState::Completed
                        | NotificationHandlerEntryState::Failed
                        | NotificationHandlerEntryState::Cancelled
                        | NotificationHandlerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(NotificationHandlerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> NotificationHandlerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<NotificationHandlerEvent> {
