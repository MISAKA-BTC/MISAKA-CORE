...
impl AddressBookState {
    ...
    pub fn create(
        ...
        let entry = AddressBookEntry {
            ...
            created_at: now,
            updated_at: now,
            state: AddressBookEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(AddressBookTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), AddressBookError> {
        ...
        self.emit(AddressBookEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, AddressBookError> {
        ...
        self.emit(AddressBookEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<AddressBookEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    AddressBookEntryState::Completed
                        | AddressBookEntryState::Failed
                        | AddressBookEntryState::Cancelled
                        | AddressBookEntryState::Expired
        ...
        if removed > 0 {
            self.emit(AddressBookEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> AddressBookStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<AddressBookEvent> {
