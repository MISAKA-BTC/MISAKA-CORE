...
impl SweepState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, SweepError> {
        ...
        self.queue.lock().push_back(SweepTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn get(&self, id: u64) -> Option<SweepEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    SweepEntryState::Completed
                        | SweepEntryState::Failed
                        | SweepEntryState::Cancelled
                        | SweepEntryState::Expired
    ...
    pub fn stats(&self) -> SweepStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<SweepEvent> {
