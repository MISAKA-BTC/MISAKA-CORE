...
impl TransactionStoreState {
    ...
    pub fn create(
        ...
        let entry = TransactionStoreEntry {
            ...
            created_at: now,
            updated_at: now,
            state: TransactionStoreEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(TransactionStoreTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), TransactionStoreError> {
        ...
        self.emit(TransactionStoreEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, TransactionStoreError> {
        ...
        self.emit(TransactionStoreEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<TransactionStoreEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    TransactionStoreEntryState::Completed
                        | TransactionStoreEntryState::Failed
                        | TransactionStoreEntryState::Cancelled
                        | TransactionStoreEntryState::Expired
        ...
        if removed > 0 {
            self.emit(TransactionStoreEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> TransactionStoreStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<TransactionStoreEvent> {
