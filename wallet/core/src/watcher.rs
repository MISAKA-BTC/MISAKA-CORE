...
impl WatcherState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, WatcherError> {
        ...
        let entry = WatcherEntry {
            ...
            created_at: now,
            updated_at: now,
            state: WatcherEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(WatcherTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), WatcherError> {
        ...
        self.emit(WatcherEvent::Completed {
            id,
    ...
    pub fn get(&self, id: u64) -> Option<WatcherEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    WatcherEntryState::Completed
                        | WatcherEntryState::Failed
                        | WatcherEntryState::Cancelled
                        | WatcherEntryState::Expired
        ...
        if removed > 0 {
            self.emit(WatcherEvent::Cleanup {
                removed,
