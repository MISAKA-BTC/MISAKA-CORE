...
impl BackupManagerState {
    ...
    pub fn create(
        ...
        let entry = BackupManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: BackupManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(BackupManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), BackupManagerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(BackupManagerError::NotFound(id))?;
        ...
        self.emit(BackupManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, BackupManagerError> {
        ...
        self.emit(BackupManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<BackupManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    BackupManagerEntryState::Completed
                        | BackupManagerEntryState::Failed
                        | BackupManagerEntryState::Cancelled
                        | BackupManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(BackupManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> BackupManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<BackupManagerEvent> {
