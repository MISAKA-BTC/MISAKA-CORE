...
impl DustManagerState {
    ...
    pub fn create(
        ...
        let entry = DustManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: DustManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(DustManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), DustManagerError> {
        ...
        self.emit(DustManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, DustManagerError> {
        ...
        self.emit(DustManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<DustManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    DustManagerEntryState::Completed
                        | DustManagerEntryState::Failed
                        | DustManagerEntryState::Cancelled
                        | DustManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(DustManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> DustManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<DustManagerEvent> {
