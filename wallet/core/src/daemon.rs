...
use crate::balance_manager::{BalanceChangeEvent, BalanceManager, Outpoint};
use crate::metrics::{WalletMetrics, WalletMetricsSnapshot};
use crate::sync::{ProcessedBlock, SyncConfig, SyncProgress, WalletSync};
...
impl WalletDaemon {
    ...
    pub fn submit_transaction(&self, pending: PendingTransaction) -> Result<(), String> {
        ...
        self.balance_manager
            .lock_utxos(&pending.locked_outpoints)
