...
impl SignerFactoryState {
    ...
    pub fn create(
        ...
        let entry = SignerFactoryEntry {
            ...
            created_at: now,
            updated_at: now,
            state: SignerFactoryEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(SignerFactoryTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), SignerFactoryError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(SignerFactoryError::NotFound(id))?;
        ...
        self.emit(SignerFactoryEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, SignerFactoryError> {
        ...
        self.emit(SignerFactoryEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<SignerFactoryEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    SignerFactoryEntryState::Completed
                        | SignerFactoryEntryState::Failed
                        | SignerFactoryEntryState::Cancelled
                        | SignerFactoryEntryState::Expired
        ...
        if removed > 0 {
            self.emit(SignerFactoryEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> SignerFactoryStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<SignerFactoryEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = SignerFactoryConfig {
            retry_count: 2,
            ..Default::default()
        };
