...
impl CompoundState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, CompoundError> {
        ...
        let entry = CompoundEntry {
            ...
            created_at: now,
            updated_at: now,
            state: CompoundEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(CompoundTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), CompoundError> {
        ...
        self.emit(CompoundEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, CompoundError> {
        ...
        self.emit(CompoundEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<CompoundEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    CompoundEntryState::Completed
                        | CompoundEntryState::Failed
                        | CompoundEntryState::Cancelled
                        | CompoundEntryState::Expired
        ...
        if removed > 0 {
            self.emit(CompoundEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> CompoundStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<CompoundEvent> {
