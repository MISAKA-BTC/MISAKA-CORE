...
//!
//! Dispatches to LRS or ChipmunkRing based on tx.ring_scheme.
...
// ChipmunkRing support (feature-gated at pqc level, always importable here)
...
pub fn validate_and_apply_block(
    ...
    for (tx_idx, vtx) in block.transactions.iter().enumerate() {
        ...
        // 1. Structural validation (handles both v1 and v2)
