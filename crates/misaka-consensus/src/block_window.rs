...
impl BlockWindowState {
    ...
    pub fn create(
        ...
        let entry = BlockWindowEntry {
            ...
            created_at: now,
            updated_at: now,
            state: BlockWindowEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(BlockWindowTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), BlockWindowError> {
        ...
        self.emit(BlockWindowEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, BlockWindowError> {
        ...
        self.emit(BlockWindowEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<BlockWindowEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    BlockWindowEntryState::Completed
                        | BlockWindowEntryState::Failed
                        | BlockWindowEntryState::Cancelled
                        | BlockWindowEntryState::Expired
        ...
        if removed > 0 {
            self.emit(BlockWindowEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> BlockWindowStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<BlockWindowEvent> {
