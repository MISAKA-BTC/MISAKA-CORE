...
impl TipsManagerState {
    ...
    pub fn create(
        ...
        let entry = TipsManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: TipsManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(TipsManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), TipsManagerError> {
        ...
        self.emit(TipsManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, TipsManagerError> {
        ...
        self.emit(TipsManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<TipsManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    TipsManagerEntryState::Completed
                        | TipsManagerEntryState::Failed
                        | TipsManagerEntryState::Cancelled
                        | TipsManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(TipsManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> TipsManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<TipsManagerEvent> {
