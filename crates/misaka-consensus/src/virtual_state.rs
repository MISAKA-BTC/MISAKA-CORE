...
impl VirtualStateState {
    ...
    pub fn create(
        ...
        let entry = VirtualStateEntry {
            ...
            created_at: now,
            updated_at: now,
            state: VirtualStateEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(VirtualStateTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), VirtualStateError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(VirtualStateError::NotFound(id))?;
        ...
        self.emit(VirtualStateEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, VirtualStateError> {
        ...
        self.emit(VirtualStateEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<VirtualStateEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    VirtualStateEntryState::Completed
                        | VirtualStateEntryState::Failed
                        | VirtualStateEntryState::Cancelled
                        | VirtualStateEntryState::Expired
        ...
        if removed > 0 {
            self.emit(VirtualStateEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> VirtualStateStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<VirtualStateEvent> {
