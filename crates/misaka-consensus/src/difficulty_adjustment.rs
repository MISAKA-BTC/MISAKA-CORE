...
impl DifficultyAdjustmentState {
    ...
    pub fn create(
        ...
        let entry = DifficultyAdjustmentEntry {
            ...
            created_at: now,
            updated_at: now,
            state: DifficultyAdjustmentEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(DifficultyAdjustmentTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), DifficultyAdjustmentError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(DifficultyAdjustmentError::NotFound(id))?;
        ...
        self.emit(DifficultyAdjustmentEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, DifficultyAdjustmentError> {
        ...
        self.emit(DifficultyAdjustmentEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<DifficultyAdjustmentEntry> {
    ...
    pub fn by_state(
        &self,
        state: DifficultyAdjustmentEntryState,
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    DifficultyAdjustmentEntryState::Completed
                        | DifficultyAdjustmentEntryState::Failed
                        | DifficultyAdjustmentEntryState::Cancelled
                        | DifficultyAdjustmentEntryState::Expired
        ...
        if removed > 0 {
            self.emit(DifficultyAdjustmentEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> DifficultyAdjustmentStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<DifficultyAdjustmentEvent> {
