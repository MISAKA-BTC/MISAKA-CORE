...
impl CoinbaseValidationRuntime {
    ...
    pub fn complete_entry(&self, id: u64) -> Result<(), CoinbaseValidationError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(CoinbaseValidationError::NotFound(id))?;
        ...
        self.emit_event(CoinbaseValidationEvent::EntryCompleted {
            id,
...
mod tests {
    ...
    fn test_retry_and_fail() {
        let config = CoinbaseValidationConfig {
            retry_count: 2,
            ..Default::default()
        };
