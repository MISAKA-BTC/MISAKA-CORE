...
impl AcceptanceDataState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, AcceptanceDataError> {
        ...
        let entry = AcceptanceDataEntry {
            ...
            created_at: now,
            updated_at: now,
            state: AcceptanceDataEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(AcceptanceDataTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), AcceptanceDataError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(AcceptanceDataError::NotFound(id))?;
        ...
        self.emit(AcceptanceDataEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, AcceptanceDataError> {
        ...
        self.emit(AcceptanceDataEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<AcceptanceDataEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    AcceptanceDataEntryState::Completed
                        | AcceptanceDataEntryState::Failed
                        | AcceptanceDataEntryState::Cancelled
                        | AcceptanceDataEntryState::Expired
        ...
        if removed > 0 {
            self.emit(AcceptanceDataEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> AcceptanceDataStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<AcceptanceDataEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = AcceptanceDataConfig {
            retry_count: 2,
            ..Default::default()
        };
