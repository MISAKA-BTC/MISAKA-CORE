...
impl BlockStatusState {
    ...
    pub fn create(
        ...
        let entry = BlockStatusEntry {
            ...
            created_at: now,
            updated_at: now,
            state: BlockStatusEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(BlockStatusTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), BlockStatusError> {
        ...
        self.emit(BlockStatusEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, BlockStatusError> {
        ...
        self.emit(BlockStatusEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<BlockStatusEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    BlockStatusEntryState::Completed
                        | BlockStatusEntryState::Failed
                        | BlockStatusEntryState::Cancelled
                        | BlockStatusEntryState::Expired
        ...
        if removed > 0 {
            self.emit(BlockStatusEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> BlockStatusStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<BlockStatusEvent> {
