...
impl ValidationRulesState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, ValidationRulesError> {
        ...
        let entry = ValidationRulesEntry {
            ...
            created_at: now,
            updated_at: now,
            state: ValidationRulesEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(ValidationRulesTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), ValidationRulesError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(ValidationRulesError::NotFound(id))?;
        ...
        self.emit(ValidationRulesEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, ValidationRulesError> {
        ...
        self.emit(ValidationRulesEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<ValidationRulesEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    ValidationRulesEntryState::Completed
                        | ValidationRulesEntryState::Failed
                        | ValidationRulesEntryState::Cancelled
                        | ValidationRulesEntryState::Expired
        ...
        if removed > 0 {
            self.emit(ValidationRulesEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> ValidationRulesStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<ValidationRulesEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = ValidationRulesConfig {
            retry_count: 2,
            ..Default::default()
        };
