...
/// ```
pub fn active_contribution(participation_rate: f64, sync_rate: f64, readiness_rate: f64) -> f64 {
...
mod tests {
    ...
    fn test_credit_linear() {
        ...
        // 20M → Credit=2.0
        let m2 = ValidatorMetrics {
            stake: 20_000_000_000_000_000,
            uptime: 1.0,
            contribution: 1.0,
            timeouts: 0,
            invalid_actions: 0,
