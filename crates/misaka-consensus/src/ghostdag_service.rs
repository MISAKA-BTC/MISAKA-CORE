...
impl GhostdagServiceState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, GhostdagServiceError> {
        ...
        let entry = GhostdagServiceEntry {
            ...
            created_at: now,
            updated_at: now,
            state: GhostdagServiceEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(GhostdagServiceTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), GhostdagServiceError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(GhostdagServiceError::NotFound(id))?;
        ...
        self.emit(GhostdagServiceEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, GhostdagServiceError> {
        ...
        self.emit(GhostdagServiceEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<GhostdagServiceEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    GhostdagServiceEntryState::Completed
                        | GhostdagServiceEntryState::Failed
                        | GhostdagServiceEntryState::Cancelled
                        | GhostdagServiceEntryState::Expired
        ...
        if removed > 0 {
            self.emit(GhostdagServiceEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> GhostdagServiceStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<GhostdagServiceEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = GhostdagServiceConfig {
            retry_count: 2,
            ..Default::default()
        };
