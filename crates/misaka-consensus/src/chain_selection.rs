...
impl ChainSelectionState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, ChainSelectionError> {
        ...
        let entry = ChainSelectionEntry {
            ...
            created_at: now,
            updated_at: now,
            state: ChainSelectionEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(ChainSelectionTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), ChainSelectionError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(ChainSelectionError::NotFound(id))?;
        ...
        self.emit(ChainSelectionEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, ChainSelectionError> {
        ...
        self.emit(ChainSelectionEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<ChainSelectionEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    ChainSelectionEntryState::Completed
                        | ChainSelectionEntryState::Failed
                        | ChainSelectionEntryState::Cancelled
                        | ChainSelectionEntryState::Expired
        ...
        if removed > 0 {
            self.emit(ChainSelectionEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> ChainSelectionStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<ChainSelectionEvent> {
