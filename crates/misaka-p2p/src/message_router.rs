...
impl MessageRouterState {
    ...
    pub fn create(
        ...
        let entry = MessageRouterEntry {
            ...
            created_at: now,
            updated_at: now,
            state: MessageRouterEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(MessageRouterTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), MessageRouterError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(MessageRouterError::NotFound(id))?;
        ...
        self.emit(MessageRouterEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, MessageRouterError> {
        ...
        self.emit(MessageRouterEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<MessageRouterEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    MessageRouterEntryState::Completed
                        | MessageRouterEntryState::Failed
                        | MessageRouterEntryState::Cancelled
                        | MessageRouterEntryState::Expired
        ...
        if removed > 0 {
            self.emit(MessageRouterEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> MessageRouterStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<MessageRouterEvent> {
