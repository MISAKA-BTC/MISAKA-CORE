...
/// SEC-FIX NM-11: Aligned with message_validation::MAX_INV_COUNT (5,000).
/// Previous value (256) was too restrictive and inconsistent.
const MAX_INV_PER_MSG: usize = crate::message_validation::MAX_INV_COUNT;
