...
impl BlockLocatorState {
    ...
    pub fn create(
        ...
        let entry = BlockLocatorEntry {
            ...
            created_at: now,
            updated_at: now,
            state: BlockLocatorEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(BlockLocatorTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), BlockLocatorError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(BlockLocatorError::NotFound(id))?;
        ...
        self.emit(BlockLocatorEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, BlockLocatorError> {
        ...
        self.emit(BlockLocatorEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<BlockLocatorEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    BlockLocatorEntryState::Completed
                        | BlockLocatorEntryState::Failed
                        | BlockLocatorEntryState::Cancelled
                        | BlockLocatorEntryState::Expired
        ...
        if removed > 0 {
            self.emit(BlockLocatorEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> BlockLocatorStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<BlockLocatorEvent> {
