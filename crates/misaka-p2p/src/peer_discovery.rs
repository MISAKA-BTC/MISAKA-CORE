...
impl PeerDiscoveryState {
    ...
    pub fn create(
        ...
        let entry = PeerDiscoveryEntry {
            ...
            created_at: now,
            updated_at: now,
            state: PeerDiscoveryEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(PeerDiscoveryTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), PeerDiscoveryError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(PeerDiscoveryError::NotFound(id))?;
        ...
        self.emit(PeerDiscoveryEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, PeerDiscoveryError> {
        ...
        self.emit(PeerDiscoveryEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<PeerDiscoveryEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    PeerDiscoveryEntryState::Completed
                        | PeerDiscoveryEntryState::Failed
                        | PeerDiscoveryEntryState::Cancelled
                        | PeerDiscoveryEntryState::Expired
        ...
        if removed > 0 {
            self.emit(PeerDiscoveryEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> PeerDiscoveryStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<PeerDiscoveryEvent> {
