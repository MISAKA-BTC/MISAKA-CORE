...
impl FlowRegistryState {
    ...
    pub fn create(
        ...
        let entry = FlowRegistryEntry {
            ...
            created_at: now,
            updated_at: now,
            state: FlowRegistryEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(FlowRegistryTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), FlowRegistryError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(FlowRegistryError::NotFound(id))?;
        ...
        self.emit(FlowRegistryEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, FlowRegistryError> {
        ...
        self.emit(FlowRegistryEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<FlowRegistryEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    FlowRegistryEntryState::Completed
                        | FlowRegistryEntryState::Failed
                        | FlowRegistryEntryState::Cancelled
                        | FlowRegistryEntryState::Expired
        ...
        if removed > 0 {
            self.emit(FlowRegistryEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> FlowRegistryStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<FlowRegistryEvent> {
