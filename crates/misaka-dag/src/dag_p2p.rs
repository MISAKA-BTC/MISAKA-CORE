...
pub const DAG_PROTOCOL_VERSION: u8 = 0x06;
...
/// v6 DAG Sync Manager — header-first, pruning-point-anchored.
...
impl DagSyncManager {
    ...
    pub fn on_headers(
        ...
        let (headers_received, validated_headers, peer_has_more) =
            match &mut self.state {
                DagSyncState::DownloadingHeaders {
                    headers_received, validated_headers, peer_has_more, ..
                } => (headers_received, validated_headers, peer_has_more),
                _ => {
