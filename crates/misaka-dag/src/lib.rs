...
//! ### 2. v1 型の再利用
//!
//! `UtxoTransaction`, `TxInput`, `TxOutput`, `OutputRef` は v1 と同一。
...
pub use shielded_hook::{
    noop_hook, NoOpShieldedHook, SharedShieldedHook, ShieldedBlockHook, ShieldedTxPayload,
};
pub use state_diff::{
...
pub use dag_block_producer::{
    ...
    run_dag_block_producer_dual, utxo_tx_to_ordered, DagMempool, DagNodeState, LocalDagValidator,
};
