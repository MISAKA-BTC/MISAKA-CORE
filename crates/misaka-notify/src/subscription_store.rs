...
impl SubscriptionStoreState {
    ...
    pub fn create(
        ...
        let entry = SubscriptionStoreEntry {
            ...
            created_at: now,
            updated_at: now,
            state: SubscriptionStoreEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(SubscriptionStoreTask {
            _entry_id: id,
            _scheduled_at: now,
            _priority: priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), SubscriptionStoreError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(SubscriptionStoreError::NotFound(id))?;
        ...
        self.emit(SubscriptionStoreEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, SubscriptionStoreError> {
        ...
        self.emit(SubscriptionStoreEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<SubscriptionStoreEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    SubscriptionStoreEntryState::Completed
                        | SubscriptionStoreEntryState::Failed
                        | SubscriptionStoreEntryState::Cancelled
                        | SubscriptionStoreEntryState::Expired
        ...
        if removed > 0 {
            self.emit(SubscriptionStoreEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> SubscriptionStoreStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<SubscriptionStoreEvent> {
