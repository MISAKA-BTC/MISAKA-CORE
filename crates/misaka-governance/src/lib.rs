...
impl Proposal {
    ...
    pub fn evaluate(&mut self, params: &GovernanceParams) {
        ...
        let quorum_required = self.total_power_snapshot * params.quorum_bps / 10_000;
...
mod tests {
    ...
    fn test_submit_and_vote_pass() {
        ...
        gov.cast_vote(&id, [1; 20], VoteChoice::Yes, 600, 105)
            .unwrap();
        gov.cast_vote(&id, [2; 20], VoteChoice::No, 100, 105)
            .unwrap();
    ...
    fn test_quorum_not_met() {
        ...
        gov.cast_vote(&id, [1; 20], VoteChoice::Yes, 200, 5)
            .unwrap();
    ...
    fn test_execution_timelock() {
        ...
        gov.cast_vote(&id, [1; 20], VoteChoice::Yes, 500, 5)
            .unwrap();
        gov.finalize_expired(11, &params);
        assert_eq!(gov.get(&id).unwrap().status, ProposalStatus::Passed);
    ...
    fn test_duplicate_vote_rejected() {
        ...
        gov.cast_vote(&id, [1; 20], VoteChoice::Yes, 500, 3)
            .unwrap();
