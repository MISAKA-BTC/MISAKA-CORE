...
impl ResponseBuilderState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, ResponseBuilderError> {
        ...
        let entry = ResponseBuilderEntry {
            ...
            created_at: now,
            updated_at: now,
            state: ResponseBuilderEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(ResponseBuilderTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), ResponseBuilderError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(ResponseBuilderError::NotFound(id))?;
        ...
        self.emit(ResponseBuilderEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, ResponseBuilderError> {
        ...
        self.emit(ResponseBuilderEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<ResponseBuilderEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    ResponseBuilderEntryState::Completed
                        | ResponseBuilderEntryState::Failed
                        | ResponseBuilderEntryState::Cancelled
                        | ResponseBuilderEntryState::Expired
        ...
        if removed > 0 {
            self.emit(ResponseBuilderEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> ResponseBuilderStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<ResponseBuilderEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = ResponseBuilderConfig {
            retry_count: 2,
            ..Default::default()
        };
