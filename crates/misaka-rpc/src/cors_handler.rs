...
impl CorsHandlerState {
    ...
    pub fn create(
        ...
        let entry = CorsHandlerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: CorsHandlerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(CorsHandlerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), CorsHandlerError> {
        ...
        self.emit(CorsHandlerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, CorsHandlerError> {
        ...
        self.emit(CorsHandlerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<CorsHandlerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    CorsHandlerEntryState::Completed
                        | CorsHandlerEntryState::Failed
                        | CorsHandlerEntryState::Cancelled
                        | CorsHandlerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(CorsHandlerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> CorsHandlerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<CorsHandlerEvent> {
