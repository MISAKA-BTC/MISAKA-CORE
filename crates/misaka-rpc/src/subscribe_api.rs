...
impl SubscribeApiState {
    ...
    pub fn create(
        ...
        let entry = SubscribeApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: SubscribeApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(SubscribeApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), SubscribeApiError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(SubscribeApiError::NotFound(id))?;
        ...
        self.emit(SubscribeApiEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, SubscribeApiError> {
        ...
        self.emit(SubscribeApiEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<SubscribeApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    SubscribeApiEntryState::Completed
                        | SubscribeApiEntryState::Failed
                        | SubscribeApiEntryState::Cancelled
                        | SubscribeApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(SubscribeApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> SubscribeApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<SubscribeApiEvent> {
