...
impl VersionNegotiationState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, VersionNegotiationError> {
        ...
        let entry = VersionNegotiationEntry {
            ...
            created_at: now,
            updated_at: now,
            state: VersionNegotiationEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(VersionNegotiationTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), VersionNegotiationError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(VersionNegotiationError::NotFound(id))?;
        ...
        self.emit(VersionNegotiationEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, VersionNegotiationError> {
        ...
        self.emit(VersionNegotiationEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<VersionNegotiationEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    VersionNegotiationEntryState::Completed
                        | VersionNegotiationEntryState::Failed
                        | VersionNegotiationEntryState::Cancelled
                        | VersionNegotiationEntryState::Expired
        ...
        if removed > 0 {
            self.emit(VersionNegotiationEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> VersionNegotiationStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<VersionNegotiationEvent> {
