...
impl RequestValidatorState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, RequestValidatorError> {
        ...
        let entry = RequestValidatorEntry {
            ...
            created_at: now,
            updated_at: now,
            state: RequestValidatorEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(RequestValidatorTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), RequestValidatorError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(RequestValidatorError::NotFound(id))?;
        ...
        self.emit(RequestValidatorEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, RequestValidatorError> {
        ...
        self.emit(RequestValidatorEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<RequestValidatorEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    RequestValidatorEntryState::Completed
                        | RequestValidatorEntryState::Failed
                        | RequestValidatorEntryState::Cancelled
                        | RequestValidatorEntryState::Expired
        ...
        if removed > 0 {
            self.emit(RequestValidatorEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> RequestValidatorStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<RequestValidatorEvent> {
