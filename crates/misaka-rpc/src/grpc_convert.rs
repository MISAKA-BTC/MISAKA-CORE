...
impl GrpcConvertState {
    ...
    pub fn create(
        ...
        let entry = GrpcConvertEntry {
            ...
            created_at: now,
            updated_at: now,
            state: GrpcConvertEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(GrpcConvertTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), GrpcConvertError> {
        ...
        self.emit(GrpcConvertEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, GrpcConvertError> {
        ...
        self.emit(GrpcConvertEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<GrpcConvertEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    GrpcConvertEntryState::Completed
                        | GrpcConvertEntryState::Failed
                        | GrpcConvertEntryState::Cancelled
                        | GrpcConvertEntryState::Expired
        ...
        if removed > 0 {
            self.emit(GrpcConvertEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> GrpcConvertStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<GrpcConvertEvent> {
