...
impl NotificationRelayState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, NotificationRelayError> {
        ...
        let entry = NotificationRelayEntry {
            ...
            created_at: now,
            updated_at: now,
            state: NotificationRelayEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(NotificationRelayTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), NotificationRelayError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(NotificationRelayError::NotFound(id))?;
        ...
        self.emit(NotificationRelayEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, NotificationRelayError> {
        ...
        self.emit(NotificationRelayEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<NotificationRelayEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    NotificationRelayEntryState::Completed
                        | NotificationRelayEntryState::Failed
                        | NotificationRelayEntryState::Cancelled
                        | NotificationRelayEntryState::Expired
        ...
        if removed > 0 {
            self.emit(NotificationRelayEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> NotificationRelayStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<NotificationRelayEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = NotificationRelayConfig {
            retry_count: 2,
            ..Default::default()
        };
