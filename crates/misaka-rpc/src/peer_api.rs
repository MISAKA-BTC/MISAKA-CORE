...
impl PeerApiState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, PeerApiError> {
        ...
        let entry = PeerApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: PeerApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(PeerApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), PeerApiError> {
        ...
        self.emit(PeerApiEvent::Completed {
            id,
    ...
    pub fn get(&self, id: u64) -> Option<PeerApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    PeerApiEntryState::Completed
                        | PeerApiEntryState::Failed
                        | PeerApiEntryState::Cancelled
                        | PeerApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(PeerApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> PeerApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<PeerApiEvent> {
