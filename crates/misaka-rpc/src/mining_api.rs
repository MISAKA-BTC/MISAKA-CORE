...
impl MiningApiState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, MiningApiError> {
        ...
        let entry = MiningApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: MiningApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(MiningApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), MiningApiError> {
        ...
        self.emit(MiningApiEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, MiningApiError> {
        ...
        self.emit(MiningApiEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<MiningApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    MiningApiEntryState::Completed
                        | MiningApiEntryState::Failed
                        | MiningApiEntryState::Cancelled
                        | MiningApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(MiningApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> MiningApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<MiningApiEvent> {
