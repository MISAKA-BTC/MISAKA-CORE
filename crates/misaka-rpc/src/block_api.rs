...
impl BlockApiState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, BlockApiError> {
        ...
        let entry = BlockApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: BlockApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(BlockApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), BlockApiError> {
        ...
        self.emit(BlockApiEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, BlockApiError> {
        ...
        self.emit(BlockApiEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<BlockApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    BlockApiEntryState::Completed
                        | BlockApiEntryState::Failed
                        | BlockApiEntryState::Cancelled
                        | BlockApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(BlockApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> BlockApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<BlockApiEvent> {
