...
impl TlsConfigState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, TlsConfigError> {
        ...
        let entry = TlsConfigEntry {
            ...
            created_at: now,
            updated_at: now,
            state: TlsConfigEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(TlsConfigTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), TlsConfigError> {
        ...
        self.emit(TlsConfigEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, TlsConfigError> {
        ...
        self.emit(TlsConfigEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<TlsConfigEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    TlsConfigEntryState::Completed
                        | TlsConfigEntryState::Failed
                        | TlsConfigEntryState::Cancelled
                        | TlsConfigEntryState::Expired
        ...
        if removed > 0 {
            self.emit(TlsConfigEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> TlsConfigStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<TlsConfigEvent> {
