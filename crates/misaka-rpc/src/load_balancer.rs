...
impl LoadBalancerState {
    ...
    pub fn create(
        ...
        let entry = LoadBalancerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: LoadBalancerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(LoadBalancerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), LoadBalancerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(LoadBalancerError::NotFound(id))?;
        ...
        self.emit(LoadBalancerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, LoadBalancerError> {
        ...
        self.emit(LoadBalancerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<LoadBalancerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    LoadBalancerEntryState::Completed
                        | LoadBalancerEntryState::Failed
                        | LoadBalancerEntryState::Cancelled
                        | LoadBalancerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(LoadBalancerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> LoadBalancerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<LoadBalancerEvent> {
