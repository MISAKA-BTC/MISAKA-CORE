...
impl BatchHandlerState {
    ...
    pub fn create(
        ...
        let entry = BatchHandlerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: BatchHandlerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(BatchHandlerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), BatchHandlerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(BatchHandlerError::NotFound(id))?;
        ...
        self.emit(BatchHandlerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, BatchHandlerError> {
        ...
        self.emit(BatchHandlerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<BatchHandlerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    BatchHandlerEntryState::Completed
                        | BatchHandlerEntryState::Failed
                        | BatchHandlerEntryState::Cancelled
                        | BatchHandlerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(BatchHandlerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> BatchHandlerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<BatchHandlerEvent> {
