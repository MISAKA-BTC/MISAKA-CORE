...
impl HealthCheckState {
    ...
    pub fn create(
        ...
        let entry = HealthCheckEntry {
            ...
            created_at: now,
            updated_at: now,
            state: HealthCheckEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(HealthCheckTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), HealthCheckError> {
        ...
        self.emit(HealthCheckEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, HealthCheckError> {
        ...
        self.emit(HealthCheckEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<HealthCheckEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    HealthCheckEntryState::Completed
                        | HealthCheckEntryState::Failed
                        | HealthCheckEntryState::Cancelled
                        | HealthCheckEntryState::Expired
        ...
        if removed > 0 {
            self.emit(HealthCheckEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> HealthCheckStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<HealthCheckEvent> {
