...
impl EncodingState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, EncodingError> {
        ...
        let entry = EncodingEntry {
            ...
            created_at: now,
            updated_at: now,
            state: EncodingEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(EncodingTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), EncodingError> {
        ...
        self.emit(EncodingEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, EncodingError> {
        ...
        self.emit(EncodingEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<EncodingEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    EncodingEntryState::Completed
                        | EncodingEntryState::Failed
                        | EncodingEntryState::Cancelled
                        | EncodingEntryState::Expired
        ...
        if removed > 0 {
            self.emit(EncodingEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> EncodingStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<EncodingEvent> {
