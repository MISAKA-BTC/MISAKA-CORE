...
impl NetworkApiState {
    ...
    pub fn create(
        ...
        let entry = NetworkApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: NetworkApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(NetworkApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), NetworkApiError> {
        ...
        self.emit(NetworkApiEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, NetworkApiError> {
        ...
        self.emit(NetworkApiEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<NetworkApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    NetworkApiEntryState::Completed
                        | NetworkApiEntryState::Failed
                        | NetworkApiEntryState::Cancelled
                        | NetworkApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(NetworkApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> NetworkApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<NetworkApiEvent> {
