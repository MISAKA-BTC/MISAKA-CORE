...
impl DagApiState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, DagApiError> {
        ...
        self.queue.lock().push_back(DagApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), DagApiError> {
        ...
        self.emit(DagApiEvent::Completed {
            id,
    ...
    pub fn get(&self, id: u64) -> Option<DagApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    DagApiEntryState::Completed
                        | DagApiEntryState::Failed
                        | DagApiEntryState::Cancelled
                        | DagApiEntryState::Expired
    ...
    pub fn stats(&self) -> DagApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<DagApiEvent> {
