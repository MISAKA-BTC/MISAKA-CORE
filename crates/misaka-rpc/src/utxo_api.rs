...
impl UtxoApiState {
    ...
    pub fn create(&self, key: String, data: Vec<u8>, priority: u32) -> Result<u64, UtxoApiError> {
        ...
        let entry = UtxoApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: UtxoApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(UtxoApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), UtxoApiError> {
        ...
        self.emit(UtxoApiEvent::Completed {
            id,
    ...
    pub fn get(&self, id: u64) -> Option<UtxoApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    UtxoApiEntryState::Completed
                        | UtxoApiEntryState::Failed
                        | UtxoApiEntryState::Cancelled
                        | UtxoApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(UtxoApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> UtxoApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<UtxoApiEvent> {
