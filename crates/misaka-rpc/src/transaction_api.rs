...
impl TransactionApiState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, TransactionApiError> {
        ...
        let entry = TransactionApiEntry {
            ...
            created_at: now,
            updated_at: now,
            state: TransactionApiEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(TransactionApiTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), TransactionApiError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(TransactionApiError::NotFound(id))?;
        ...
        self.emit(TransactionApiEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, TransactionApiError> {
        ...
        self.emit(TransactionApiEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<TransactionApiEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    TransactionApiEntryState::Completed
                        | TransactionApiEntryState::Failed
                        | TransactionApiEntryState::Cancelled
                        | TransactionApiEntryState::Expired
        ...
        if removed > 0 {
            self.emit(TransactionApiEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> TransactionApiStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<TransactionApiEvent> {
