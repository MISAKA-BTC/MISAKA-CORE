...
impl WebsocketHandlerState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, WebsocketHandlerError> {
        ...
        let entry = WebsocketHandlerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: WebsocketHandlerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(WebsocketHandlerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), WebsocketHandlerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(WebsocketHandlerError::NotFound(id))?;
        ...
        self.emit(WebsocketHandlerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, WebsocketHandlerError> {
        ...
        self.emit(WebsocketHandlerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<WebsocketHandlerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    WebsocketHandlerEntryState::Completed
                        | WebsocketHandlerEntryState::Failed
                        | WebsocketHandlerEntryState::Cancelled
                        | WebsocketHandlerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(WebsocketHandlerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> WebsocketHandlerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<WebsocketHandlerEvent> {
