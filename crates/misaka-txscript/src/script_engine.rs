...
/// CRIT-1 FIX: Real ML-DSA-65 verification via misaka-pqc.
///
/// Calls `dilithium3::verify_detached_signature()` — NOT a stub.
/// Returns false on any verification failure (invalid key, bad sig, tampered message).
