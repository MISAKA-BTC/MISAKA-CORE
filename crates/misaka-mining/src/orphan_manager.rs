...
impl OrphanManagerState {
    ...
    pub fn create(
        ...
        let entry = OrphanManagerEntry {
            ...
            created_at: now,
            updated_at: now,
            state: OrphanManagerEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(OrphanManagerTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), OrphanManagerError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(OrphanManagerError::NotFound(id))?;
        ...
        self.emit(OrphanManagerEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, OrphanManagerError> {
        ...
        self.emit(OrphanManagerEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<OrphanManagerEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    OrphanManagerEntryState::Completed
                        | OrphanManagerEntryState::Failed
                        | OrphanManagerEntryState::Cancelled
                        | OrphanManagerEntryState::Expired
        ...
        if removed > 0 {
            self.emit(OrphanManagerEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> OrphanManagerStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<OrphanManagerEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = OrphanManagerConfig {
            retry_count: 2,
            ..Default::default()
        };
