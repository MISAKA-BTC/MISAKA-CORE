...
impl RewardCalculatorState {
    ...
    pub fn create(
        ...
        data: Vec<u8>,
        priority: u32,
    ) -> Result<u64, RewardCalculatorError> {
        ...
        let entry = RewardCalculatorEntry {
            ...
            created_at: now,
            updated_at: now,
            state: RewardCalculatorEntryState::Queued,
            priority,
            retry_count: 0,
            data,
        ...
        self.queue.lock().push_back(RewardCalculatorTask {
            entry_id: id,
            scheduled_at: now,
            priority,
        });
    ...
    pub fn complete(&self, id: u64) -> Result<(), RewardCalculatorError> {
        ...
        let entry = entries
            .get_mut(&id)
            .ok_or(RewardCalculatorError::NotFound(id))?;
        ...
        self.emit(RewardCalculatorEvent::Completed {
            id,
    ...
    pub fn fail(&self, id: u64, reason: String) -> Result<bool, RewardCalculatorError> {
        ...
        self.emit(RewardCalculatorEvent::Failed {
            id,
            reason,
            will_retry,
        });
    ...
    pub fn get(&self, id: u64) -> Option<RewardCalculatorEntry> {
    ...
    pub fn cleanup(&self) -> usize {
        ...
        let to_remove: Vec<u64> = entries
            ...
            .filter(|(_, e)| {
                matches!(
                    e.state,
                    RewardCalculatorEntryState::Completed
                        | RewardCalculatorEntryState::Failed
                        | RewardCalculatorEntryState::Cancelled
                        | RewardCalculatorEntryState::Expired
        ...
        if removed > 0 {
            self.emit(RewardCalculatorEvent::Cleanup {
                removed,
    ...
    pub fn stats(&self) -> RewardCalculatorStatsSnapshot {
        self.stats.snapshot()
    }
    pub fn drain_events(&self) -> Vec<RewardCalculatorEvent> {
...
mod tests {
    ...
    #[test]
    fn test_retry() {
        let config = RewardCalculatorConfig {
            retry_count: 2,
            ..Default::default()
        };
