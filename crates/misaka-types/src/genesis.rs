...
pub struct ChainProfile {
    ...
    /// Require ML-DSA-65 PQ signature for all txs.
    ...
    // MED-1: ring signature fields (min_ring_size, max_anonymity_set) removed — purged in v10.
}

impl ChainProfile {
    /// Deterministic genesis timestamp: 2025-01-01T00:00:00Z.
    /// All nodes must use the same value to produce identical genesis hashes.
    ...
    pub fn testnet() -> Self {
        Self {
            ...
            genesis_timestamp_ms: Self::GENESIS_TIMESTAMP_MS,
            pq_tx_required: true,
