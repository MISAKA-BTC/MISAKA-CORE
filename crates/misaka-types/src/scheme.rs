...
//! - **LaRRS**: Reserved for future lattice ZKP proof extensions
//!
...
pub enum SignatureScheme {
    ...
    MlDsa65 = 0x01,
    /// Lattice lattice ZKP proof (MISAKA-LRS-v1). Variable size.
    LatticeRing = 0x02,
}
...
mod tests {
    ...
    fn test_ml_dsa_address_derivation() {
        ...
        let addr = pk.to_canonical_id();
        assert_eq!(addr.len(), 20);
        assert_eq!(pk.to_canonical_id(), pk.to_canonical_id()); // deterministic
    }
