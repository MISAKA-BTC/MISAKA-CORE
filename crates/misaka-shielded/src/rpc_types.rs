...
pub struct ShieldedModuleStatusResponse {
    ...
    /// Layer 4 proof backend の現在状態
    pub layer4_status: ShieldedLayer4Status,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum ShieldedProofBackendPhaseTag {
    Stub,
    Shell,
    Real,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum ShieldedProofBackendKindTag {
    Stub,
    Groth16,
    Plonk,
    Sha3Merkle,
...
pub struct ShieldedProofBackendStatusEntry {
    pub circuit_version: u16,
    pub backend_id: String,
    pub backend_kind: ShieldedProofBackendKindTag,
    pub phase: ShieldedProofBackendPhaseTag,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub verifying_key_fingerprint: Option<String>,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum ShieldedAuthoritativeBackendTargetTag {
    Groth16,
    Plonk,
    Groth16OrPlonk,
}
...
#[serde(rename_all = "snake_case")]
pub enum ShieldedVkPolicyModeTag {
    Disabled,
    Observe,
    Require,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct ShieldedVerifierContractStatus {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub membership_backend: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transfer_backend: Option<String>,
    pub canonical_public_input_schema: u8,
    pub shell_proof_envelope_schema: u8,
    pub authoritative_target: ShieldedAuthoritativeBackendTargetTag,
    pub authoritative_target_ready: bool,
    pub groth16_shell_compiled: bool,
    pub plonk_shell_compiled: bool,
    pub groth16_vk_policy: ShieldedVkPolicyModeTag,
    pub plonk_vk_policy: ShieldedVkPolicyModeTag,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub groth16_vk_fingerprint: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plonk_vk_fingerprint: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub groth16_vk_artifact_schema: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plonk_vk_artifact_schema: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub groth16_vk_fingerprint_algorithm: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plonk_vk_fingerprint_algorithm: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub groth16_vk_artifact_payload_length: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plonk_vk_artifact_payload_length: Option<u32>,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct ShieldedLayer4Status {
    pub backend_selection_mode: String,
    pub real_backend_ready: bool,
    pub transfer_backend_ready: bool,
    pub groth16_plonk_ready: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub preferred_production_backend: Option<String>,
    pub registered_backends: Vec<ShieldedProofBackendStatusEntry>,
    pub catalog_backends: Vec<ShieldedProofBackendStatusEntry>,
    pub verifier_contract: ShieldedVerifierContractStatus,
}
