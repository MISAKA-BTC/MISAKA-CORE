...
pub use proof_backend::{
    parse_verifying_key_artifact, CircuitRegistry, Groth16Backend, Groth16VerifierAdapter,
    ParsedGroth16ProofPayload, ParsedPlonkProofPayload, ParsedVerifyingKeyArtifact, PlonkBackend,
    PlonkVerifierAdapter, ProofBackend, ProofBackendDescriptor, ProofBackendKind,
    ProofBackendPhase, ProofBackendRuntimeStatus, ProofError, Sha3MerkleProofBackend,
    StubProofBackend, VK_ARTIFACT_SCHEMA_V1, VK_FINGERPRINT_ALGO_BLAKE3_V1,
};
pub use rpc_types::{ShieldedAuthoritativeBackendTargetTag, ShieldedVkPolicyModeTag};
pub use sha3_proof::{
    Sha3TransferProofBackend, Sha3TransferProofBuilder, Sha3TransferProofBuilderV3,
};
...
pub use storage::{
    write_shield_set_to_batch, ShieldedBatch, ALL_SHIELDED_CFS, CF_SHIELD_CIRCUIT_VKEYS,
    CF_SHIELD_COMMITMENTS, CF_SHIELD_FRONTIER, CF_SHIELD_NOTES_ENC, CF_SHIELD_NULLIFIERS,
    CF_SHIELD_ROOTS,
};
pub use tx_types::{
    ShieldDepositTx, ShieldWithdrawTx, ShieldedTransferTx, ShieldedTxError, MAX_NULLIFIERS_PER_TX,
    MAX_OUTPUTS_PER_TX, MIN_SHIELDED_FEE,
};
pub use types::{
...
pub use wallet_scanner::{
    LocalNullifierCache, NoteScanner, NullifierChecker, PaymentProof, ScanStats, ScannedBlock,
    ScannedNote, WalletScanError,
};
